...
## [v10.0.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v10.0.0) - 2022-04-18
...
## [v9.0.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v9.0.0) - 2022-01-10
...
* Fix bug in the transaction submission where requests with large transaction payloads fail with an HTTP 414 URI Too Long error ([#3643](https://github.com/TosinShada/monorepo/pull/3643)).
* Fix a data race in `Client.fixHorizonURL`([#3690](https://github.com/TosinShada/monorepo/pull/3690)).
* Fix bug which occurs when parsing operations involving muxed accounts ([#3722](https://github.com/TosinShada/monorepo/pull/3722)).
...
Added new client methods and effects supporting [Protocol 14](https://github.com/TosinShada/monorepo/issues/3035).
...
## [v2.2.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v2.2.0) - 2020-03-26
...
## [v2.1.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v2.1.0) - 2020-02-24

### Added

- Add `client.StrictReceivePaths` and  `client.StrictSendPaths` ([#2237](https://github.com/TosinShada/monorepo/pull/2237)).
...
- Add `client.OfferDetails` ([#2303](https://github.com/TosinShada/monorepo/pull/2303)).
...
- Add support to `client.Offers` for the filters: `Seller`, `Selling` and `Buying` ([#2230](https://github.com/TosinShada/monorepo/pull/2230)).
```go
	...
	fmt.Print(offers)
```
- Add `client.Accounts` ([#2229](https://github.com/TosinShada/monorepo/pull/2229)).
...
- Add `IsNotFoundError` ([#2197](https://github.com/TosinShada/monorepo/pull/2197)).

### Deprecated

- Make `hProtocol.FeeStats` backwards compatible with Horizon `0.24.1` and `1.0` deprecating usage of `*_accepted_fee` ([#2290](https://github.com/TosinShada/monorepo/pull/2290)).
...
## [v2.0.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v2.0.0) - 2020-01-13
...
- Add support for querying operation endpoint with `join` parameter [#1521](https://github.com/TosinShada/monorepo/issues/1521).
...
- Added support for returning the previous and next set of pages for a horizon response; issue [#985](https://github.com/TosinShada/monorepo/issues/985).
- Fixed bug reported in [#1254](https://github.com/TosinShada/monorepo/issues/1254)  that causes a panic when using horizonclient in goroutines.


## [v1.1.0](https://github.com/TosinShada/monorepo/releases/tag/horizonclient-v1.1.0) - 2019-05-02

### Added

- `Client.Root()` method for querying the root endpoint of a horizon server.
- Support for returning concrete effect types[#1217](https://github.com/TosinShada/monorepo/pull/1217)
...
- Querying the effects endpoint now supports returning the concrete effect type for each effect. This is also supported in streaming mode. See the [docs](https://godoc.org/github.com/TosinShada/monorepo/clients/horizonclient#Client.Effects) for examples.
