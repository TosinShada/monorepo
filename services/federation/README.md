...
[Prebuilt binaries](https://github.com/TosinShada/monorepo/releases) of the federation server are available on the [releases page](https://github.com/TosinShada/monorepo/releases).
...
```
go get -u github.com/TosinShada/monorepo/services/federation
```
